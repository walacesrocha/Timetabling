...
Explicar aqui que tem 3 formulações do ITC-2007 ...
...
\item \textbf{Tabela-horário de Escola} The weekly scheduling for all the classes of a
school, avoiding teachers meeting two classes at the same time,
and vice versa;


\item \textbf{Tabela-horário de Universidade}

\item \textbf{Tabela-horário de Exames}
