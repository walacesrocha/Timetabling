...
De acordo com \cite{Resende05graspwith}, \textit{Path-Relinking} é uma melhoria ao algoritmo básico do GRASP, proporcionando melhoras tanto no tempo quanto na qualidade de solução.

Ainda de acordo com \cite{Resende05graspwith}, existem duas estratégias diferentes de aplicar o PR no GRASP:
