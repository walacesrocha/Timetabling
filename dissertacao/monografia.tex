...
As restrições fortes são aquelas que não podem ser violadas, como por exemplo, restringir que o aluno só assista uma aula num dado horário ou exigir que num dado horário uma sala só possa ser ocupada por uma aula. Se uma tabela-horário não viola nenhuma restrição forte ela é dita ser uma solução viável. 
