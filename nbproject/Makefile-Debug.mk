...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/Cygwin-Windows/alggenetico.exe

dist/Debug/Cygwin-Windows/alggenetico.exe: ${OBJECTFILES}
...
${OBJECTDIR}/populacao.o: nbproject/Makefile-${CND_CONF}.mk populacao.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/populacao.o populacao.c
...
${OBJECTDIR}/agenda.o: nbproject/Makefile-${CND_CONF}.mk agenda.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/agenda.o agenda.c

${OBJECTDIR}/problema.o: nbproject/Makefile-${CND_CONF}.mk problema.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/problema.o problema.c

${OBJECTDIR}/buscalocal.o: nbproject/Makefile-${CND_CONF}.mk buscalocal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/buscalocal.o buscalocal.c

${OBJECTDIR}/auxiliar.o: nbproject/Makefile-${CND_CONF}.mk auxiliar.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/auxiliar.o auxiliar.c
...
${OBJECTDIR}/individuo.o: nbproject/Makefile-${CND_CONF}.mk individuo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/individuo.o individuo.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/Cygwin-Windows/alggenetico.exe
