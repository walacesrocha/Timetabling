...
Na área de programação matemática, bons resultados têm sido obtidos com programação inteira. Em \cite{lach_lubbecke} pode ser vista uma formulação, que foi implementada usando CPLEX9 e conseguiu soluções com respostas bem próximas às melhores obtidas na competição ITC-2007.
, \cite{broek_hurkens} e \cite{Burke_abranch-andcut}.
