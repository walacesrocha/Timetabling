...
\item Escolas: \cite{artigo_geraldo}; \cite{artigo_geraldo_luiz}; \cite{artigo_angelo}

\item Universidades: \cite{artigo_gerald_marco}; \cite{artigo_broek_hurkens}

\item Exames: \cite{artigo_burke_newall_weare}; \cite{artigo_burke_qu_soghier}; \cite{artigo_kahar_kendall}
